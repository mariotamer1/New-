# Pro Cabrera's Painting LLC — one-page site

Interior and exterior painting, siding and general construction. Renton, Washington.
...
```js
const CONFIG = {
  phone: "(425) 361-3300",   // tap-to-call, shown across the site
  ...
  serviceAreas: [],          // ["Renton","Kent","Newcastle","Tukwila","Bellevue"]
...
The three comparisons are drawn in code (illustrations of typical surface
damage and finished work), so the section works with no photography.
